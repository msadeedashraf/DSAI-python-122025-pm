# Polymorphism and Advanced OOP Concepts in Bank Account Management

# Extending the BankAccount class to create SavingsAccount and CurrentAccount with specific features

# Overloading and Overriding Methods in Child Classes


# BankAccount.withdraw() # balance cant go below zero
# CurrentAccount.withdraw() # Overriding in action # balance can go below zero up to overdraft limit
# SavingsAccount uses parents withdraw() method (no overdraft)


# Overriding # same signature # same method name and same parameters

# Overloading # different signatures # method name same but parameters different


# withdraw method signature is same in both parent (BankAccount class) and child (CurrentAccount class) classes

# def withdraw(self, amount):

# Different signature for withdraw method means overloading # due to fee being added as parameter

# def withdraw(self,fee, amount):
...
class CurrentAccount(BankAccount):
    ...
    def withdraw(
        self, amount
    ):  # Overriding the withdraw method # Polymorphism in action
        if not self.is_active:
            print(
